...
function LoginPage() {
  return (
    <div className="w-full h-screen flex justify-center items-center bg-gray-900">
      <div className="w-[95%] max-w-7xl h-auto md:h-[85%] bg-dark rounded-3xl shadow-2xl flex flex-col md:flex-row overflow-hidden relative">
        {/* Seccion Izquierda*/}
        <div className="w-full md:w-1/2 bg-primary flex items-center justify-center p-12 overflow-hidden relative">
          <img
            src={logo}
            alt="Logo del Proyecto"
            className="max-w-[400px] w-full object-contain z-10"
          />
