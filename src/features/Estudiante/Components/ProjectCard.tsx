...
export default function ProjectCard({ project, onAddProgress, onShowDetails }: ProjectCardProps) {
    return (
        <div className="bg-[#1e293b] p-6 rounded-2xl border border-gray-700 flex flex-col justify-between shadow-lg">
            <header className="flex items-center justify-between mb-4">
                <div>
                    ...
                    <span className="text-sm text-gray-400">Materia: {project.subject}</span>
                </div>
                <span
                    className={`
